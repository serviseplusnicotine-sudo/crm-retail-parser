...
// ТИМЧАСОВО на тарифі Pro (4GB RAM/2CPU) для швидкого первинного прогріву
// кешу цін (1095 товарів). На Standard (2GB) було 3 — з запасом, щоб не
// повторити OOM-краш-луп на 512MB. Після прогріву кешу планується відкат
// назад на Standard — тоді ЦЕ ЧИСЛО ТРЕБА ПОВЕРНУТИ НАЗАД НА 3, інакше на
// 2GB знову будуть падіння по пам'яті.
