...
// Повернуто на 3 після відкату тарифу Render назад на Standard (2GB/1CPU).
// Було тимчасово піднято до 6 на тарифі Pro (4GB/2CPU) для швидкого
// первинного прогріву кешу цін (1095+ товарів) — прогрів завершився
// (кеш повний), тариф знижено назад, тому й це число повертаємо до
// безпечного значення. НЕ піднімати без апгрейду тарифу — на 2GB це
// призводило до OOM-краш-лупу (перевірено на практиці).
